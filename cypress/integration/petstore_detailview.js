...
describe("On pet's detail view", function() {
  ...
  it('should be possible to cancel editing', function() {
    cy.request('POST', '/petstore/api/v1/pet/', {"name":timestamp,"petType":"Fish","birthDate":"2019-10-22T21:00:00.000Z"})
      .then((response) => {
        expect(response.body).to.have.property('name', timestamp)
      })
  })
